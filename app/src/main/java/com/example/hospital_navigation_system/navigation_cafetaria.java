...
public class navigation_cafetaria extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigation_cafetaria);
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(navigation_cafetaria.this,
        ...
        list2.add("Tea Time Cafe");
        list2.add("Subway Cafe");



        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(navigation_cafetaria.this,
