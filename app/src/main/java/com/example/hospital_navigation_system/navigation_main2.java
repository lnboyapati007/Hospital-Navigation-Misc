...
public class navigation_main2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list2.add("CE 10");
        list2.add("Pharmacy");
        list2.add("Macmillan Therapy");
        list2.add("WashRoom 1");
        list2.add("WashRoom 2");
        list2.add("Blood Test");
        list2.add("Quiet Room");
        list2.add("Main Entrance");


        list2.add("Treatment Room 1");
        list2.add("Treatment Room 2");
        list2.add("Treatment Room 3");
        list2.add("B1 Staff Room");
        list2.add("Staff Change Area");
        list2.add("Main Treatment Area");
        list2.add("B1 Washroom 3");
        list2.add("B1 Washroom 4");
        list2.add("B1 Cafe");
        list2.add("Meeting Room 1");
        list2.add("Meeting Room 2");
        list2.add("Nurse Office");
        list2.add("Hematology Office");
