...
public class navigation_restrooms extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigation_restrooms);
        ...
        list1.add("CE 10");
        list1.add("Pharmacy");
        list1.add("Macmillan Therapy");
        list1.add("WashRoom 1");
        list1.add("WashRoom 2");
        list1.add("Blood Test");
        list1.add("Quiet Room");
        list1.add("Main Entrance");
        list1.add("Tea Time Cafe");




        list1.add("Treatment Room 1");
        list1.add("Treatment Room 2");
        list1.add("Treatment Room 3");
        list1.add("B1 Staff Room");
        list1.add("Staff Change Area");
        list1.add("Main Treatment Area");
        list1.add("B1 Washroom 3");
        list1.add("B1 Washroom 4");
        list1.add("Subway Cafe");
        list1.add("Meeting Room 1");
        list1.add("Meeting Room 2");
        list1.add("Nurse Office");
        list1.add("Hematology Office");


        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(navigation_restrooms.this,
        ...
        list2.add("WashRoom 1");
        list2.add("WashRoom 2");
        list2.add("B1 Washroom 3");
        list2.add("B1 Washroom 4");


        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(navigation_restrooms.this,
...
//        Floor b_1 = b.getFloor( -1 );
        ...
        Room cafeb0 = new Room( "Tea Time Cafe", b0, v_b0_34);
        ...
        Room b1cafe = new Room( "Subway Cafe", b1, v_b1_8);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        System.out.println("Class  :  " + firstOne.getClass().getName());
    ...
    public void clickMe(View view) {
        ...
        if( first != null && second != null) {
            if (select1) {
                ...
                Navigation navi = new Navigation(context, first, second, scan);
