...
public class navigation_pharmacy extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigation_pharmacy);
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(navigation_pharmacy.this,
        ...
        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(navigation_pharmacy.this,
